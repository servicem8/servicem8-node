...
exports.tool$jobContactsCreateJobContacts = void 0;
...
exports.tool$jobContactsCreateJobContacts = {
...
UUID is optional for record creation. If no UUID is supplied, a UUID will be automatically generated for the new record and returned in the response header as x-record-uuid.
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, jobContactsCreateJobContacts_js_1.jobContactsCreateJobContacts)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
