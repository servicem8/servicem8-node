...
exports.tool$categoriesDeleteCategories = void 0;
...
exports.tool$categoriesDeleteCategories = {
...
This endpoint requires the following OAuth scope **manage_job_categories**.
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, categoriesDeleteCategories_js_1.categoriesDeleteCategories)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
