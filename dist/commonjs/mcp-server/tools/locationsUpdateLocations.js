...
exports.tool$locationsUpdateLocations = void 0;
...
exports.tool$locationsUpdateLocations = {
...
This endpoint requires the following OAuth scope **manage_locations**.
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, locationsUpdateLocations_js_1.locationsUpdateLocations)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
