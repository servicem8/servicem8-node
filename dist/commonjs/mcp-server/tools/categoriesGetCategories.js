...
exports.tool$categoriesGetCategories = void 0;
...
exports.tool$categoriesGetCategories = {
...
This endpoint requires the following OAuth scope **read_job_categories**.
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, categoriesGetCategories_js_1.categoriesGetCategories)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
