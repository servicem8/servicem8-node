 ...
 */
export declare function companyContactsCreateCompanyContacts(client: ServiceM8Core, request: components.CompanyContactInput, options?: RequestOptions): APIPromise<Result<operations.CreateCompanyContactsResponse, errors.ErrorT | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=companyContactsCreateCompanyContacts.d.ts.map