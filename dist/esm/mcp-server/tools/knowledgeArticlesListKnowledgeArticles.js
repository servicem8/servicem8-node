...
export const tool$knowledgeArticlesListKnowledgeArticles = {
...
This endpoint requires the following OAuth scope **read_knowledge**.
    ...
    tool: async (client, ctx) => {
        const [result, apiCall] = await knowledgeArticlesListKnowledgeArticles(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
