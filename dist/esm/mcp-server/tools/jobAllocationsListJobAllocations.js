...
export const tool$jobAllocationsListJobAllocations = {
...
This endpoint requires the following OAuth scope **read_schedule**.
    ...
    tool: async (client, ctx) => {
        const [result, apiCall] = await jobAllocationsListJobAllocations(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
