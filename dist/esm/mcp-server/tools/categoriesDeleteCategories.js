...
export const tool$categoriesDeleteCategories = {
...
This endpoint requires the following OAuth scope **manage_job_categories**.
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await categoriesDeleteCategories(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
