...
export const tool$categoriesGetCategories = {
...
This endpoint requires the following OAuth scope **read_job_categories**.
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await categoriesGetCategories(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
