...
export const tool$smsTemplatesUpdateSMSTemplates = {
    name: "SMS-templates-update-SMS-templates",
    description: `Update a SMS Template`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await smsTemplatesUpdateSMSTemplates(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
