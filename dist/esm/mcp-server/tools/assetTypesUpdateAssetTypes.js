...
export const tool$assetTypesUpdateAssetTypes = {
    name: "asset-types-update-asset-types",
    description: `Update an Asset Type`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await assetTypesUpdateAssetTypes(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
