...
export class JobAllocations extends ClientSDK {
    ...
    async listJobAllocations(options) {
        return unwrapAsync(jobAllocationsListJobAllocations(this, options));
    }
    /**
    ...
    async createJobAllocations(request, options) {
        return unwrapAsync(jobAllocationsCreateJobAllocations(this, request, options));
    }
    /**
    ...
    async getJobAllocations(request, options) {
        return unwrapAsync(jobAllocationsGetJobAllocations(this, request, options));
    }
    /**
     * Update a Job Allocation
     */
    async updateJobAllocations(request, options) {
        return unwrapAsync(jobAllocationsUpdateJobAllocations(this, request, options));
    }
    /**
    ...
    async deleteJobAllocations(request, options) {
        return unwrapAsync(jobAllocationsDeleteJobAllocations(this, request, options));
    }
}
