...
export class Vendors extends ClientSDK {
    ...
    async listVendors(options) {
        return unwrapAsync(vendorsListVendors(this, options));
    }
    /**
     * Retrieve a Vendor
     *
    ...
    async getVendors(request, options) {
        return unwrapAsync(vendorsGetVendors(this, request, options));
    }
    /**
     * Update a Vendor
     *
    ...
    async updateVendors(request, options) {
        return unwrapAsync(vendorsUpdateVendors(this, request, options));
    }
}
