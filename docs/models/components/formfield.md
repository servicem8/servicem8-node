...
let value: FormField = {
  formUuid: "123e4567-6ddc-411a-b974-23eb29f4b29b",
  uuid: "123e4567-4341-492c-96e3-23eb2915f76b",
...
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `formUuid`                                                                               | *string*                                                                                 | :heavy_minus_sign:                                                                       | The UUID of the form this field belongs to.                                              | 123e4567-6ddc-411a-b974-23eb29f4b29b                                                     |
...
| `uuid`                                                                                   | *string*                                                                                 | :heavy_minus_sign:                                                                       | Unique identifier for this record                                                        | 123e4567-4341-492c-96e3-23eb2915f76b                                                     |
