 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace QueueRequiresAssignment$ {
  /** @deprecated use `QueueRequiresAssignment$inboundSchema` instead. */
  export const inboundSchema = QueueRequiresAssignment$inboundSchema;
  /** @deprecated use `QueueRequiresAssignment$outboundSchema` instead. */
  export const outboundSchema = QueueRequiresAssignment$outboundSchema;
}
