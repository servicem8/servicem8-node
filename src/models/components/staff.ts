 ...
 */
export namespace StaffHideFromSchedule$ {
  /** @deprecated use `StaffHideFromSchedule$inboundSchema` instead. */
  export const inboundSchema = StaffHideFromSchedule$inboundSchema;
  /** @deprecated use `StaffHideFromSchedule$outboundSchema` instead. */
  export const outboundSchema = StaffHideFromSchedule$outboundSchema;
}
