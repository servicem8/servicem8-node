...
export namespace InboxMessage$ {
  /** @deprecated use `InboxMessage$inboundSchema` instead. */
  export const inboundSchema = InboxMessage$inboundSchema;
  /** @deprecated use `InboxMessage$outboundSchema` instead. */
  export const outboundSchema = InboxMessage$outboundSchema;
  /** @deprecated use `InboxMessage$Outbound` instead. */
  export type Outbound = InboxMessage$Outbound;
}
