 ...
 */
export namespace MaterialPriceIncludesTaxes$ {
  /** @deprecated use `MaterialPriceIncludesTaxes$inboundSchema` instead. */
  export const inboundSchema = MaterialPriceIncludesTaxes$inboundSchema;
  /** @deprecated use `MaterialPriceIncludesTaxes$outboundSchema` instead. */
  export const outboundSchema = MaterialPriceIncludesTaxes$outboundSchema;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace MaterialItemIsInventoried$ {
  /** @deprecated use `MaterialItemIsInventoried$inboundSchema` instead. */
  export const inboundSchema = MaterialItemIsInventoried$inboundSchema;
  /** @deprecated use `MaterialItemIsInventoried$outboundSchema` instead. */
  export const outboundSchema = MaterialItemIsInventoried$outboundSchema;
}
