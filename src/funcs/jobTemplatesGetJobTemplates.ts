 ...
 */
export function jobTemplatesGetJobTemplates(
  client: ServiceM8Core,
  request: operations.GetJobTemplatesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJobTemplatesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetJobTemplatesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetJobTemplatesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetJobTemplatesResponse$inboundSchema),
