 ...
 */
export function companyContactsCreateCompanyContacts(
  client: ServiceM8Core,
  request: components.CompanyContactInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateCompanyContactsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => components.CompanyContactInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateCompanyContactsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateCompanyContactsResponse$inboundSchema, {
      key: "Result",
    }),
