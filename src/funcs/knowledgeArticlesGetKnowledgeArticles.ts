 ...
 */
export function knowledgeArticlesGetKnowledgeArticles(
  client: ServiceM8Core,
  request: operations.GetKnowledgeArticlesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetKnowledgeArticlesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetKnowledgeArticlesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetKnowledgeArticlesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetKnowledgeArticlesResponse$inboundSchema),
