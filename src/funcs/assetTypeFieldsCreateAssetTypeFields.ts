...
export function assetTypeFieldsCreateAssetTypeFields(
  ...
  Result<
    operations.CreateAssetTypeFieldsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateAssetTypeFieldsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateAssetTypeFieldsResponse$inboundSchema, {
      key: "Result",
    }),
