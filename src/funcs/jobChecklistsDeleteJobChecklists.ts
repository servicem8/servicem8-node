 ...
 */
export function jobChecklistsDeleteJobChecklists(
  client: ServiceM8Core,
  request: operations.DeleteJobChecklistsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteJobChecklistsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteJobChecklistsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteJobChecklistsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteJobChecklistsResponse$inboundSchema),
