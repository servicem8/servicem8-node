 ...
 */
export function documentTemplatesGetDocumentTemplates(
  client: ServiceM8Core,
  request: operations.GetDocumentTemplatesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetDocumentTemplatesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDocumentTemplatesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDocumentTemplatesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetDocumentTemplatesResponse$inboundSchema),
