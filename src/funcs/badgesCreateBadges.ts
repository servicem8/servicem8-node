 ...
 */
export function badgesCreateBadges(
  client: ServiceM8Core,
  request: components.BadgeInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateBadgesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => components.BadgeInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateBadgesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateBadgesResponse$inboundSchema, {
      key: "Result",
    }),
