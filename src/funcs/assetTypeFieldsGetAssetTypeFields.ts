 ...
 */
export function assetTypeFieldsGetAssetTypeFields(
  client: ServiceM8Core,
  request: operations.GetAssetTypeFieldsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAssetTypeFieldsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAssetTypeFieldsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetAssetTypeFieldsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetAssetTypeFieldsResponse$inboundSchema),
