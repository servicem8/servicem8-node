 ...
 */
export function jobQueuesGetJobQueues(
  client: ServiceM8Core,
  request: operations.GetJobQueuesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJobQueuesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetJobQueuesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetJobQueuesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetJobQueuesResponse$inboundSchema),
