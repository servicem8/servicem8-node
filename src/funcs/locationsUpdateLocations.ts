 ...
 */
export function locationsUpdateLocations(
  client: ServiceM8Core,
  request: operations.UpdateLocationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateLocationsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateLocationsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateLocationsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateLocationsResponse$inboundSchema),
