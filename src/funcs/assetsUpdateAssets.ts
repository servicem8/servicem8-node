 ...
 * Update an Asset
 */
export function assetsUpdateAssets(
  client: ServiceM8Core,
  request: operations.UpdateAssetsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateAssetsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateAssetsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateAssetsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateAssetsResponse$inboundSchema),
