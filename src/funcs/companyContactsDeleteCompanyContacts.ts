 ...
 */
export function companyContactsDeleteCompanyContacts(
  client: ServiceM8Core,
  request: operations.DeleteCompanyContactsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteCompanyContactsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteCompanyContactsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteCompanyContactsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteCompanyContactsResponse$inboundSchema),
