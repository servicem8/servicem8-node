...
export function staffMessagesCreateStaffMessages(
  ...
  Result<
    operations.CreateStaffMessagesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateStaffMessagesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateStaffMessagesResponse$inboundSchema, {
      key: "Result",
    }),
