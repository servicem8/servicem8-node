 ...
 * Update a Feedback
 */
export function feedbackUpdateFeedback(
  client: ServiceM8Core,
  request: operations.UpdateFeedbackRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateFeedbackResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateFeedbackRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateFeedbackResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateFeedbackResponse$inboundSchema),
