 ...
 */
export function jobsCreateJobs(
  client: ServiceM8Core,
  request: components.JobInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateJobsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => components.JobInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateJobsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateJobsResponse$inboundSchema, {
      key: "Result",
    }),
