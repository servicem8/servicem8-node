 ...
 */
export function assetsGetAssets(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAssetsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAssetsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetAssetsResponse$inboundSchema),
