 ...
 */
export function materialsDeleteMaterials(
  client: ServiceM8Core,
  request: operations.DeleteMaterialsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteMaterialsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteMaterialsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteMaterialsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteMaterialsResponse$inboundSchema),
