...
export function jobContactsCreateJobContacts(
  ...
  Result<
    operations.CreateJobContactsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateJobContactsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateJobContactsResponse$inboundSchema, {
      key: "Result",
    }),
