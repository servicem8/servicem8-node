 ...
 */
export function categoriesDeleteCategories(
  client: ServiceM8Core,
  request: operations.DeleteCategoriesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteCategoriesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteCategoriesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteCategoriesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteCategoriesResponse$inboundSchema),
