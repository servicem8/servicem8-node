 ...
 */
export function jobChecklistsUpdateJobChecklists(
  client: ServiceM8Core,
  request: operations.UpdateJobChecklistsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateJobChecklistsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateJobChecklistsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateJobChecklistsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateJobChecklistsResponse$inboundSchema),
