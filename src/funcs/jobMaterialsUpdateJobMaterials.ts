 ...
 */
export function jobMaterialsUpdateJobMaterials(
  client: ServiceM8Core,
  request: operations.UpdateJobMaterialsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateJobMaterialsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateJobMaterialsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateJobMaterialsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateJobMaterialsResponse$inboundSchema),
