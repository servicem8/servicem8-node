 ...
 */
export function suppliersUpdateSuppliers(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateSuppliersRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SupplierCreate, { explode: true });
  ...
  const path = pathToFunc("/supplier/{uuid}.json")(pathParams);
