 ...
 */
export function formsDeleteForms(
  client: ServiceM8Core,
  request: operations.DeleteFormsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteFormsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteFormsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteFormsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteFormsResponse$inboundSchema),
