 ...
 */
export function formFieldsDeleteFormFields(
  client: ServiceM8Core,
  request: operations.DeleteFormFieldsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteFormFieldsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteFormFieldsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteFormFieldsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteFormFieldsResponse$inboundSchema),
