 ...
 * Update a Note
 */
export function notesUpdateNotes(
  client: ServiceM8Core,
  request: operations.UpdateNotesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateNotesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateNotesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateNotesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateNotesResponse$inboundSchema),
