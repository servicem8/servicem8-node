 ...
 */
export function jobContactsUpdateJobContacts(
  client: ServiceM8Core,
  request: operations.UpdateJobContactsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateJobContactsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateJobContactsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateJobContactsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateJobContactsResponse$inboundSchema),
