 ...
 */
export function jobContactsListJobContacts(
  client: ServiceM8Core,
  security: operations.ListJobContactsSecurity,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListJobContactsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListJobContactsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListJobContactsResponse$inboundSchema),
