 ...
 */
export function smsTemplatesDeleteSMSTemplates(
  client: ServiceM8Core,
  request: operations.DeleteSMSTemplatesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteSMSTemplatesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteSMSTemplatesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteSMSTemplatesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteSMSTemplatesResponse$inboundSchema),
