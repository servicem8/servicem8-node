 ...
 */
export function jobContactsDeleteJobContacts(
  client: ServiceM8Core,
  request: operations.DeleteJobContactsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteJobContactsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteJobContactsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteJobContactsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteJobContactsResponse$inboundSchema),
