 ...
 */
export function jobMaterialBundlesDeleteJobMaterialBundles(
  ...
  Result<
    operations.DeleteJobMaterialBundlesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteJobMaterialBundlesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteJobMaterialBundlesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.DeleteJobMaterialBundlesResponse$inboundSchema,
    ),
