 ...
 */
export function staffMembersGetStaffMembers(
  client: ServiceM8Core,
  request: operations.GetStaffMembersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetStaffMembersResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetStaffMembersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetStaffMembersResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetStaffMembersResponse$inboundSchema),
