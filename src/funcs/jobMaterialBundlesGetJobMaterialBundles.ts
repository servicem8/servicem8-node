 ...
 */
export function jobMaterialBundlesGetJobMaterialBundles(
  client: ServiceM8Core,
  request: operations.GetJobMaterialBundlesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJobMaterialBundlesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetJobMaterialBundlesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetJobMaterialBundlesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetJobMaterialBundlesResponse$inboundSchema),
