 ...
 */
export function materialsGetMaterials(
  client: ServiceM8Core,
  request: operations.GetMaterialsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetMaterialsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMaterialsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetMaterialsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetMaterialsResponse$inboundSchema),
