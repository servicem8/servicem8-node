 ...
 */
export function categoriesUpdateCategories(
  client: ServiceM8Core,
  request: operations.UpdateCategoriesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateCategoriesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateCategoriesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateCategoriesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateCategoriesResponse$inboundSchema),
