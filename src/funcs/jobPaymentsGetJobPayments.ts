 ...
 */
export function jobPaymentsGetJobPayments(
  client: ServiceM8Core,
  request: operations.GetJobPaymentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJobPaymentsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetJobPaymentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetJobPaymentsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetJobPaymentsResponse$inboundSchema),
