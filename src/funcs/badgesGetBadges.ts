 ...
 */
export function badgesGetBadges(
  client: ServiceM8Core,
  request: operations.GetBadgesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetBadgesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetBadgesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetBadgesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetBadgesResponse$inboundSchema),
