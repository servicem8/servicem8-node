 ...
 */
export function formResponsesUpdateFormResponses(
  client: ServiceM8Core,
  request: operations.UpdateFormResponsesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateFormResponsesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateFormResponsesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateFormResponsesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateFormResponsesResponse$inboundSchema),
