 ...
 */
export function formFieldsUpdateFormFields(
  client: ServiceM8Core,
  request: operations.UpdateFormFieldsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateFormFieldsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateFormFieldsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateFormFieldsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateFormFieldsResponse$inboundSchema),
