 ...
 */
export function staffMembersListStaffMembers(
  client: ServiceM8Core,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListStaffMembersResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListStaffMembersResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListStaffMembersResponse$inboundSchema),
