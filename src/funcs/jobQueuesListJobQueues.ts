 ...
 */
export function jobQueuesListJobQueues(
  client: ServiceM8Core,
  security: operations.ListJobQueuesSecurity,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListJobQueuesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListJobQueuesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListJobQueuesResponse$inboundSchema),
