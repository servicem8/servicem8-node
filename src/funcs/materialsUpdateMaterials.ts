 ...
 */
export function materialsUpdateMaterials(
  client: ServiceM8Core,
  request: operations.UpdateMaterialsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateMaterialsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateMaterialsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateMaterialsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateMaterialsResponse$inboundSchema),
