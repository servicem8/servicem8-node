 ...
 */
export function jobActivitiesUpdateJobActivities(
  client: ServiceM8Core,
  request: operations.UpdateJobActivitiesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateJobActivitiesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateJobActivitiesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateJobActivitiesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateJobActivitiesResponse$inboundSchema),
