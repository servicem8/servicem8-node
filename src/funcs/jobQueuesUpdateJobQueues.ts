 ...
 */
export function jobQueuesUpdateJobQueues(
  client: ServiceM8Core,
  request: operations.UpdateJobQueuesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateJobQueuesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateJobQueuesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateJobQueuesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateJobQueuesResponse$inboundSchema),
