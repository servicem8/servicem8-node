 ...
 */
export function documentTemplatesDeleteDocumentTemplates(
  client: ServiceM8Core,
  request: operations.DeleteDocumentTemplatesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteDocumentTemplatesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteDocumentTemplatesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteDocumentTemplatesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteDocumentTemplatesResponse$inboundSchema),
