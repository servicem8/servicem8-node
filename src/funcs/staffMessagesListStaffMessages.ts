...
export function staffMessagesListStaffMessages(
  ...
  Result<
    operations.ListStaffMessagesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListStaffMessagesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListStaffMessagesResponse$inboundSchema),
