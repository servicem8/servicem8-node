 ...
 */
export function locationsCreateLocations(
  client: ServiceM8Core,
  request: components.LocationInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateLocationsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => components.LocationInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateLocationsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateLocationsResponse$inboundSchema, {
      key: "Result",
    }),
