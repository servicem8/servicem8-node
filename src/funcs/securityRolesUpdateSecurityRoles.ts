 ...
 */
export function securityRolesUpdateSecurityRoles(
  client: ServiceM8Core,
  request: operations.UpdateSecurityRolesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateSecurityRolesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateSecurityRolesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateSecurityRolesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateSecurityRolesResponse$inboundSchema),
