 ...
 */
export function jobAllocationsGetJobAllocations(
  client: ServiceM8Core,
  request: operations.GetJobAllocationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJobAllocationsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetJobAllocationsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetJobAllocationsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetJobAllocationsResponse$inboundSchema),
