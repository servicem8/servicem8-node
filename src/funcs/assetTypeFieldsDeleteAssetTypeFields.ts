 ...
 */
export function assetTypeFieldsDeleteAssetTypeFields(
  client: ServiceM8Core,
  request: operations.DeleteAssetTypeFieldsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteAssetTypeFieldsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteAssetTypeFieldsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteAssetTypeFieldsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteAssetTypeFieldsResponse$inboundSchema),
