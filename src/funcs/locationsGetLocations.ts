 ...
 */
export function locationsGetLocations(
  client: ServiceM8Core,
  request: operations.GetLocationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetLocationsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetLocationsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetLocationsResponse$inboundSchema),
