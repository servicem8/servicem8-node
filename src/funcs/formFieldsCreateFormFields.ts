 ...
 */
export function formFieldsCreateFormFields(
  client: ServiceM8Core,
  request: components.FormFieldInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateFormFieldsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => components.FormFieldInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateFormFieldsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateFormFieldsResponse$inboundSchema, {
      key: "Result",
    }),
