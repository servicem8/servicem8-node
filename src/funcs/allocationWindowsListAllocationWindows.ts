 ...
 */
export function allocationWindowsListAllocationWindows(
  client: ServiceM8Core,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListAllocationWindowsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAllocationWindowsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListAllocationWindowsResponse$inboundSchema),
