 ...
 */
export function smsTemplatesGetSMSTemplates(
  client: ServiceM8Core,
  request: operations.GetSMSTemplatesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetSMSTemplatesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSMSTemplatesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetSMSTemplatesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetSMSTemplatesResponse$inboundSchema),
