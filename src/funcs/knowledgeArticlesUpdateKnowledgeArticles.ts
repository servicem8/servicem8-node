 ...
 */
export function knowledgeArticlesUpdateKnowledgeArticles(
  client: ServiceM8Core,
  request: operations.UpdateKnowledgeArticlesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateKnowledgeArticlesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateKnowledgeArticlesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateKnowledgeArticlesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateKnowledgeArticlesResponse$inboundSchema),
