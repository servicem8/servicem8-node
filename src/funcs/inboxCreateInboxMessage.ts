 ...
 */
export function inboxCreateInboxMessage(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.CreateInboxMessageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.InboxMessageDetail$inboundSchema),
