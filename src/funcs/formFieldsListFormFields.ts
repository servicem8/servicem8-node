...
export function formFieldsListFormFields(
  ...
  Result<
    operations.ListFormFieldsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListFormFieldsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListFormFieldsResponse$inboundSchema),
