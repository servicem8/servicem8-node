 ...
 */
export function staffMembersUpdateStaffMembers(
  client: ServiceM8Core,
  request: operations.UpdateStaffMembersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateStaffMembersResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateStaffMembersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateStaffMembersResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateStaffMembersResponse$inboundSchema),
