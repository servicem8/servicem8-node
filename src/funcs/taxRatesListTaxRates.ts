 ...
 */
export function taxRatesListTaxRates(
  client: ServiceM8Core,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListTaxRatesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListTaxRatesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListTaxRatesResponse$inboundSchema),
