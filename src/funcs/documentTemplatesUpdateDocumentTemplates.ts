...
export function documentTemplatesUpdateDocumentTemplates(
  ...
  Result<
    operations.UpdateDocumentTemplatesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateDocumentTemplatesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DocumentTemplate, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateDocumentTemplatesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateDocumentTemplatesResponse$inboundSchema),
