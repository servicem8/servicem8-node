 ...
 */
export function companyContactsGetCompanyContacts(
  client: ServiceM8Core,
  request: operations.GetCompanyContactsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCompanyContactsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCompanyContactsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCompanyContactsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetCompanyContactsResponse$inboundSchema),
