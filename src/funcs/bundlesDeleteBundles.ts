 ...
 */
export function bundlesDeleteBundles(
  client: ServiceM8Core,
  request: operations.DeleteBundlesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteBundlesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteBundlesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteBundlesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteBundlesResponse$inboundSchema),
