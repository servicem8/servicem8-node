 ...
 */
export function jobMaterialBundlesCreateJobMaterialBundles(
  ...
  Result<
    operations.CreateJobMaterialBundlesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => components.JobMaterialBundleInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateJobMaterialBundlesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.json(
      "default",
      operations.CreateJobMaterialBundlesResponse$inboundSchema,
      { key: "Result" },
    ),
