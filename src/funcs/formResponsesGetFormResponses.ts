 ...
 */
export function formResponsesGetFormResponses(
  client: ServiceM8Core,
  request: operations.GetFormResponsesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetFormResponsesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFormResponsesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFormResponsesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetFormResponsesResponse$inboundSchema),
