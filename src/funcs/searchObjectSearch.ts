 ...
 */
export function searchObjectSearch(
  client: ServiceM8Core,
  request: operations.ObjectSearchRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ObjectSearchResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ObjectSearchRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    objectType: encodeSimple("objectType", payload.objectType, {
      explode: false,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ObjectSearchResponse$inboundSchema),
    M.jsonErr([400, 429], errors.ErrorT$inboundSchema),
