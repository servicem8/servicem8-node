 ...
 */
export function formFieldsGetFormFields(
  client: ServiceM8Core,
  request: operations.GetFormFieldsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetFormFieldsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFormFieldsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetFormFieldsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetFormFieldsResponse$inboundSchema),
