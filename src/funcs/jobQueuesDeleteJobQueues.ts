 ...
 */
export function jobQueuesDeleteJobQueues(
  client: ServiceM8Core,
  request: operations.DeleteJobQueuesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteJobQueuesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteJobQueuesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteJobQueuesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteJobQueuesResponse$inboundSchema),
