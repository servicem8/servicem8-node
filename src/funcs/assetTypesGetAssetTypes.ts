 ...
 */
export function assetTypesGetAssetTypes(
  client: ServiceM8Core,
  request: operations.GetAssetTypesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAssetTypesResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAssetTypesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAssetTypesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetAssetTypesResponse$inboundSchema),
