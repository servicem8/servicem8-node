 ...
 */
export function staffMembersDeleteStaffMembers(
  client: ServiceM8Core,
  request: operations.DeleteStaffMembersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteStaffMembersResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteStaffMembersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteStaffMembersResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteStaffMembersResponse$inboundSchema),
