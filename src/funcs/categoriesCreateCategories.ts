...
export function categoriesCreateCategories(
  ...
  Result<
    operations.CreateCategoriesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateCategoriesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateCategoriesResponse$inboundSchema, {
      key: "Result",
    }),
