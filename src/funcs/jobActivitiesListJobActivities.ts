 ...
 */
export function jobActivitiesListJobActivities(
  client: ServiceM8Core,
  security: operations.ListJobActivitiesSecurity,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListJobActivitiesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListJobActivitiesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListJobActivitiesResponse$inboundSchema),
