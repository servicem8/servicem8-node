 ...
 */
export function jobPaymentsDeleteJobPayments(
  client: ServiceM8Core,
  request: operations.DeleteJobPaymentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteJobPaymentsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteJobPaymentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteJobPaymentsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteJobPaymentsResponse$inboundSchema),
