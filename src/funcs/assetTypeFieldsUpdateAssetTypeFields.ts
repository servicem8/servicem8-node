 ...
 */
export function assetTypeFieldsUpdateAssetTypeFields(
  client: ServiceM8Core,
  request: operations.UpdateAssetTypeFieldsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateAssetTypeFieldsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateAssetTypeFieldsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateAssetTypeFieldsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateAssetTypeFieldsResponse$inboundSchema),
