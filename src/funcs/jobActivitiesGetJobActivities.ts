 ...
 */
export function jobActivitiesGetJobActivities(
  client: ServiceM8Core,
  request: operations.GetJobActivitiesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJobActivitiesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetJobActivitiesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetJobActivitiesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetJobActivitiesResponse$inboundSchema),
