 ...
 */
export function inboxArchiveInboxMessage(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ArchiveInboxMessageRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ArchiveRequest, { explode: true });
  ...
  const path = pathToFunc("/inboxmessage/{uuid}/archive.json")(pathParams);
