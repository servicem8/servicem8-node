 ...
 */
export function attachmentsUpdateAttachments(
  client: ServiceM8Core,
  request: operations.UpdateAttachmentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateAttachmentsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateAttachmentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateAttachmentsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateAttachmentsResponse$inboundSchema),
