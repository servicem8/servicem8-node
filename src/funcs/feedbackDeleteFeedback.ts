 ...
 */
export function feedbackDeleteFeedback(
  client: ServiceM8Core,
  request: operations.DeleteFeedbackRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteFeedbackResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteFeedbackRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteFeedbackResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteFeedbackResponse$inboundSchema),
