 ...
 */
export function jobsDeleteJobs(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteJobsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteJobsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteJobsResponse$inboundSchema),
