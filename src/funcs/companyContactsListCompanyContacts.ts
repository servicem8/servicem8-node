 ...
 */
export function companyContactsListCompanyContacts(
  client: ServiceM8Core,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListCompanyContactsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListCompanyContactsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListCompanyContactsResponse$inboundSchema),
