 ...
 */
export function materialsCreateMaterials(
  client: ServiceM8Core,
  request: components.MaterialInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateMaterialsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => components.MaterialInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateMaterialsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CreateMaterialsResponse$inboundSchema, {
      key: "Result",
    }),
