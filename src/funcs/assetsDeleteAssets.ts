 ...
 */
export function assetsDeleteAssets(
  client: ServiceM8Core,
  request: operations.DeleteAssetsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteAssetsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteAssetsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteAssetsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteAssetsResponse$inboundSchema),
