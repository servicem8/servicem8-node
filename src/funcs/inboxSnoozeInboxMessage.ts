 ...
 */
export function inboxSnoozeInboxMessage(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SnoozeInboxMessageRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SnoozeRequest, { explode: true });
  ...
  const path = pathToFunc("/inboxmessage/{uuid}/snooze.json")(pathParams);
