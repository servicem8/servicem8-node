 ...
 */
export function jobContactsGetJobContacts(
  client: ServiceM8Core,
  request: operations.GetJobContactsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJobContactsResponse,
    | errors.ErrorT
    | ServiceM8Error
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetJobContactsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetJobContactsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetJobContactsResponse$inboundSchema),
