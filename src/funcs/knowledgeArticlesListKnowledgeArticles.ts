 ...
 */
export function knowledgeArticlesListKnowledgeArticles(
  client: ServiceM8Core,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListKnowledgeArticlesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListKnowledgeArticlesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListKnowledgeArticlesResponse$inboundSchema),
