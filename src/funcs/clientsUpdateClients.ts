 ...
 */
export function clientsUpdateClients(
  client: ServiceM8Core,
  request: operations.UpdateClientsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateClientsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateClientsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateClientsResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateClientsResponse$inboundSchema),
