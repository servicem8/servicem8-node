 ...
 */
export function jobActivitiesDeleteJobActivities(
  client: ServiceM8Core,
  request: operations.DeleteJobActivitiesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteJobActivitiesResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteJobActivitiesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteJobActivitiesResponse$inboundSchema),
    M.jsonErr(400, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteJobActivitiesResponse$inboundSchema),
